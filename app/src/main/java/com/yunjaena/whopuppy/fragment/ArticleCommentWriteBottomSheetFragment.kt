...
import com.yunjaena.whopuppy.databinding.FragmentArticleCommentWriteBottomSheetBinding
...
class ArticleCommentWriteBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private fun setCommentEditTextListener() {
        binding.addCommentEditText.addTextChangedListener { setVisibilitySendButton() }
    }
